...
benchmarking. The simulation will run for 20 iterations.
"""
...
if args.device == "cython":
    ...
    import pyglasma3d_numba_source.gauss as gauss  # noqa: E402
