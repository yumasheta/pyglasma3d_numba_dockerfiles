...
This is a simplified version of the mv.py script that only initializes
the simulation object and is used for benchmarking.
"""
...
parser = argparse.ArgumentParser(
    ...
    prog="python -m examples.mv_init_bench",
)
parser.add_argument(
    "-o",
    "--output",
    type=str,
    default="mv_init_bench",
    metavar="<name>",
    dest="run",
...
# for cuda runs force to sync kernels
if args.device == "cuda":
